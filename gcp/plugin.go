...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"gcp_cloud_asset_access_policy":                           tableGcpCloudAssetAccessPolicy(ctx),
			"gcp_cloud_asset_iam_policy":                              tableGcpCloudAssetIamPolicy(ctx),
			"gcp_cloud_asset_org_policy":                              tableGcpCloudAssetOrgPolicy(ctx),
			"gcp_cloud_asset_os_inventory":                            tableGcpCloudAssetOsInventory(ctx),
			"gcp_cloud_asset_relationship":                            tableGcpCloudAssetRelationship(ctx),
			"gcp_cloud_asset_resource":                                tableGcpCloudAssetResource(ctx),
