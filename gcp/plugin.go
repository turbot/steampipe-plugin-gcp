...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"gcp_compute_disk_metric_write_ops_daily":                 tableGcpComputeGcpDiskMetricWriteOpsDaily(ctx),
			...
			"gcp_compute_instance_metric_cpu_utilization":             tableGcpComputeInstanceCpuUtilizationMetric(ctx),
			"gcp_compute_instance_metric_cpu_utilization_daily":       tableGcpComputeInstanceCpuUtilizationMetricDaily(ctx),
			"gcp_compute_instance_metric_cpu_utilization_hourly":      tableGcpComputeInstanceCpuUtilizationMetricHourly(ctx),
