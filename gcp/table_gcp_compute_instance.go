...
func tableGcpComputeInstance(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			// machine_type_name is a simpler view of the type, without the full path
			...
			{Name: "akas", Type: proto.ColumnType_JSON, Transform: transform.From(instanceAka), Description: resourceInterfaceDescription("akas")},
			...
			{Name: "location", Type: proto.ColumnType_STRING, Transform: transform.FromField("Zone").Transform(lastPathElement), Description: resourceInterfaceDescription("location")},
			{Name: "location_type", Type: proto.ColumnType_STRING, Transform: transform.FromConstant("zone"), Description: resourceInterfaceDescription("location_type")},
		},
	}
}
...
func listComputeInstances(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	logger.Warn("listComputeInstances", "d.QueryContext.Quals", d.QueryContext.Quals)
...
func instanceAka(_ context.Context, d *transform.TransformData) (interface{}, error) {
	...
	// ex: gcp://compute.googleapis.com/projects/morales-aaa/zones/us-central1-a/instances/instance-1
