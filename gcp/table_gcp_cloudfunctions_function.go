...
func tableGcpCloudfunctionFunction(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "akas", Type: proto.ColumnType_JSON, Transform: transform.From(functionAka), Description: ColumnDescriptionAkas},
			...
			{Name: "location", Type: proto.ColumnType_STRING, Transform: transform.FromField("Name").Transform(locationFromFunctionName), Description: ColumnDescriptionLocation},
		},
	}
}
